...
class InitiateKeyRotationCommand(object):
    def __init__(self):
        pass


class InitiateKeyRotationCommandHandler(CommandHandler):
    def __init__(self):
        self.queue = taskqueue.Queue(name=u'key-rotation-queue')

    @property
    def message_type(self):
        return InitiateKeyRotationCommand
    ...
    def __create_task_for(self, service_account_id):
        url = u'/keyRotation/serviceAccounts/{}/keys'.format(service_account_id)
